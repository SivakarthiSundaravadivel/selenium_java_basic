...
//         fail with custom error message:
        ...
        String errortest = "this is fails";
        String expectedresult = "this is Also a Button";
        WebElement button = driver.findElement(By.id("ButtonId"));
        assertTrue(button.getAttribute("value").equalsIgnoreCase(expectedresult));
        assertTrue(errortest, button.getAttribute("value").equalsIgnoreCase(expectedresult));
    }
